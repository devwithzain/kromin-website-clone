...
// 			<motion.div className="w-[70%] sm:w-full xm:w-full mx-auto h-full flex sm:flex-col xm:flex-col  justify-between gap-4 padding-x">
// 				<motion.div className="flex flex-col gap-20 w-[500px] h-[500px] sm:w-full xm:w-full">
	...
	return (
		<motion.section className="w-full padding-y bg-white">
			{portfolioItems.map((item) => (
				<motion.div
					key={item.id}
					className="w-[80%] sm:w-full xm:w-full mx-auto flex sm:flex-col xm:flex-col  justify-between gap-10 padding-x mb-10">
					<motion.div className="flex flex-col gap-20 w-[500px] h-[500px] sm:w-full xm:w-full">
						<div className="w-full h-full">
							<video
								className="w-full h-full"
